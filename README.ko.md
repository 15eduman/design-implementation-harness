...
python3 design-harness/scripts/score_visual_diff.py \
  design-harness/captures/source/screen.source.png \
  design-harness/captures/candidate/screen.candidate.png \
  --out design-harness/captures/diff/screen.diff.json
```
